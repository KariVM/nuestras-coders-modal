var selection = document.getElementById('select-promo');
var imagesContainer = document.getElementById('images-container');
//-var subImageContiner = null;


selection.addEventListener('change', showPromo);
...
//agragamos atributos a la imagen de esta manera

function showCoders(arr, promo){
  /* -if(subImageContiner)
    imagesContainer.removeChild(subImageContiner);
    subImageContiner = document.createElement('div');
    imagesContainer.appendChild(subImageContiner); */
...
function createImage(promo , nombre){
  ...
  // -subImageContiner.appendChild(img);
}
...
function showModal (event) {
  ...
  //ubicando al 25% para que se centre, no tiene contenedor
